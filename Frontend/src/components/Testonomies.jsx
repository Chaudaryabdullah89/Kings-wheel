    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl py-16 mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16" data-aos="fade-down">
            <h2 className="text-4xl font-bold text-gray-900 sm:text-5xl mb-6 bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent" style={{font : 'karla'}}>
            What Our Clients Say
          </h2>
          <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto" style={{font : 'Poppins'}}  >
              ...
              <div className="bg-white z-10 rounded-2xl cursor-pointer shadow-xl p-8 h-full transform transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden group" data-aos="flip-left" data-aos-delay={index * 100}>
                ...
                <div className="relative">
                  <div className="flex items-center mb-6" data-aos="fade-right" data-aos-delay={index * 150}>
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-gray-900" style={{font : 'karla'}}>
                        {testimonial.name}
                      </h3>
                      <p className="text-sm text-gray-600" style={{font : 'Poppins'}}>
                  ...
                  <div className="relative" data-aos="zoom-in" data-aos-delay={index * 200}>
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed pl-4" style={{font : 'Poppins'}}>
                      {testimonial.content}
                    </p>
                  </div>
                </div>
