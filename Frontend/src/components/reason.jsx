      ...
      <div className="grid md:grid-cols-2 gap-24 items-center ">
        <div className="" >
          ...
          <div className="flex mt-10 flex-col gap-4 space-y-3  ">
            <div className="  bg-white p-6 flex items-center gap-5 text-black rounded-lg " >
              ...
              <p>
                Built to withstand heavy commercial traffic and extreme weather
                conditions
              </p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-yellow-500 p-2 rounded-[50%] ">
              ...
              <p>
                Vertical and horizontal steel reinforcement for maximum load
                resistance
              </p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-yellow-500 p-2 rounded-[50%] ">
              ...
              <p>
                Precision-lined anchor points prevent cracking during
                installation
              </p>
                </div>
            </div>
            <div className=" bg-blue-900 p-6 text-white rounded-lg italic font-semibold " >
              <p>
