            ...
            <div className="space-y-8" >
                ...
                <div className="space-y-6 text">
                    <p className="border-l-4 border-yellow-400 pl-4 font-family-{poppins}"
                       data-aos="fade-left" data-aos-delay="100" style={{fontFamily: 'Poppins'}}>
                    ...
                    <div className="relative group" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <div className="relative bg-gray-800 p-6 rounded-lg">
                            <p style={{fontFamily: 'Karla'}} className='text-lg' >
                    ...
                    <p className="italic text-gray-300"
                       data-aos="fade-left" data-aos-delay="300" style={{fontFamily: 'Poppins'}}>
