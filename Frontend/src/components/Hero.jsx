      ...
      <div className="hero-container flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="hero-content w-full lg:w-[50%]">
            <div className="space-y-4">
              <span className="  text-yellow-500 font-semibold tracking-wider uppercase" data-aos="fade-right">Welcome to King Wheel Stop</span>
              <h1 className='text-4xl lg:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent heading leading-tight' data-aos="fade-right">
                Precision Built. Contractor Trusted. Texas Tough.</h1>
              ...
              <p data-aos="fade-up" className='text-lg text-gray-600 leading-relaxed font-light'>
            ...
            <div className="mt-10">
                <Link to="/contact"  className='flex flex-col sm:flex-row gap-4 items-center'>
                    <Button data-aos="zoom-in" data-aos-anchor-placement="bottom-bottom" text="Contact Us" value={'Get a Quote in 24 Hours'} />
                    <Button data-aos="zoom-in" data-aos-anchor-placement="bottom-bottom" text="Contact Us" value={'See Photos of Our Work'} />
                </Link>
            </div>
        </div>
        ...
        <div className='hero-image relative' data-aos="fade-left">
            ...
            <img src={heroImage} alt="King Wheel Stop Installation" 
